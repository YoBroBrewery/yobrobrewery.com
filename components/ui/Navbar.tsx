...
const Navbar: React.FC = () => {
  ...
  return (
    <header className='fixed top-0 z-10 w-full bg-blue shadow-md'>
      {/* <Banner /> */}
          ...
          <div className='flex w-full justify-between md:w-fit'>
            ...
            <div className='flex items-center md:hidden'>
              <button
                ...
                className='text-2xl text-red focus:outline-none'
              >
